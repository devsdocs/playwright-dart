...
## 3.10.0- **Test Coverage**: Increased core DOM interaction API test coverage from 13.7% to 49.1%. Added comprehensive tests for `ElementHandle`, `Frame`, `FrameLocator`, `Mouse`, and `Keyboard` APIs.
