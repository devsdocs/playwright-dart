...
void main() {
  group('HtmlReporter', () {
    ...
    test('should generate comprehensive HTML report with meaningful results', () async {
      ...
      reporter.addTestResult(TestResult(
        ...
        duration: 2340,
        steps: [
          TestStep(title: 'Navigate to login page', duration: 450, status: 'passed'),
          TestStep(title: 'Enter username', duration: 120, status: 'passed'),
          TestStep(title: 'Enter password', duration: 95, status: 'passed'),
          TestStep(title: 'Click login button', duration: 890, status: 'passed'),
          TestStep(title: 'Verify redirect to dashboard', duration: 785, status: 'passed'),
        ],
        metadata: {
          'browser': 'chromium',
          'viewport': '1920x1080',
      ...
      reporter.addTestResult(TestResult(
        ...
        duration: 5670,
        error: 'Expected payment button to be visible, but it was not found',
        stackTrace: '''
    ...
    at async Object.<anonymous> (test/checkout/checkout_test.dart:44:5)''',
        ...
        steps: [
          TestStep(title: 'Add item to cart', duration: 890, status: 'passed'),
          TestStep(title: 'Navigate to checkout', duration: 560, status: 'passed'),
          TestStep(title: 'Enter shipping address', duration: 1240, status: 'passed'),
          TestStep(title: 'Select payment method', duration: 780, status: 'passed'),
          TestStep(title: 'Complete payment', duration: 2200, status: 'failed', error: 'Expected payment button to be visible'),
        ],
        retryCount: 1,
        metadata: {
          'browser': 'chromium',
      ...
      reporter.addTestResult(TestResult(
        ...
        steps: [
          TestStep(title: 'Navigate to search page', duration: 340, status: 'passed'),
          TestStep(title: 'Enter search query', duration: 180, status: 'passed'),
          TestStep(title: 'Submit search', duration: 890, status: 'passed'),
          TestStep(title: 'Verify search results', duration: 1710, status: 'passed'),
        ],
        attachments: [
          TestAttachment(
      ...
      reporter.addTestResult(TestResult(
        ...
        duration: 15400,
        steps: [
          TestStep(title: 'Navigate to upload page', duration: 320, status: 'passed'),
          TestStep(title: 'Select large file (100MB)', duration: 150, status: 'passed'),
          TestStep(title: 'Start upload', duration: 14930, status: 'passed'),
        ],
        metadata: {
          'browser': 'chromium',
          'viewport': '1920x1080',
